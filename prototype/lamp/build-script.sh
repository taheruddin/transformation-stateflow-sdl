...
# Generate code for OpenGEODE function lamp
cd "$SKELS"/lamp && opengeode --toAda lamp.pr system_structure.pr && cd $OLDPWD

cd "$SKELS" && rm -f lamp.zip && zip lamp lamp/* && cd $OLDPWD
