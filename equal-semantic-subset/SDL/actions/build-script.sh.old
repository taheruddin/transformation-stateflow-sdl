...
# Generate code for OpenGEODE function actions
cd "$SKELS"/actions && opengeode --toAda actions.pr system_structure.pr && cd $OLDPWD

cd "$SKELS" && rm -f actions.zip && zip actions actions/* && cd $OLDPWD
...
cd "$CWD" && assert-builder-ocarina.py \
	...
	-o "$OUTPUTDIR" \
	--subAda actions:"$SKELS"/actions.zip \
