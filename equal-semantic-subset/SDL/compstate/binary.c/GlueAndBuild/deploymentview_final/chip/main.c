...
extern void init_gui (void);
extern void init_compstate (void);
extern void init_compstate (void);
extern void init_compstate (void);
extern void init_compstate (void);
extern void init_compstate (void);
...
process_package__taste_protected_object compstate_protected;
 ...
 */
  ...
  compstate_protected.protected_id = 1;
...
/*!
 * Store the period time for task vt_compstate_switch_on
 */
  __po_hi_milliseconds (&(period), 1);
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (chip_vt_compstate_switch_on_k, &(period), 1, 50000, 0, vt_compstate_switch_on_job);
  
/*!
 * Store the period time for task vt_compstate_switch_off
 */
  __po_hi_milliseconds (&(period), 1);
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (chip_vt_compstate_switch_off_k, &(period), 1, 50000, 0, vt_compstate_switch_off_job);
  
/*!
 * Store the period time for task vt_compstate_restart
 */
  __po_hi_milliseconds (&(period), 1);
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (chip_vt_compstate_restart_k, &(period), 1, 50000, 0, vt_compstate_restart_job);
  
/*!
 * Store the period time for task vt_compstate_start_recording
 */
  __po_hi_milliseconds (&(period), 1);
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (chip_vt_compstate_start_recording_k, &(period), 1, 50000, 0, vt_compstate_start_recording_job);
  
/*!
 * Store the period time for task vt_compstate_pause
 */
  __po_hi_milliseconds (&(period), 1);
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (chip_vt_compstate_pause_k, &(period), 1, 50000, 0, vt_compstate_pause_job);
  
/*!
 * Store the period time for task vt_compstate_resume
 */
  __po_hi_milliseconds (&(period), 1);
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (chip_vt_compstate_resume_k, &(period), 1, 50000, 0, vt_compstate_resume_job);
  
/*!
 * Store the period time for task vt_compstate_stop_recording
 */
  __po_hi_milliseconds (&(period), 1);
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (chip_vt_compstate_stop_recording_k, &(period), 1, 50000, 0, vt_compstate_stop_recording_job);
  
/*!
 * Store the period time for task vt_compstate_fail
 */
  __po_hi_milliseconds (&(period), 1);
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (chip_vt_compstate_fail_k, &(period), 1, 50000, 0, vt_compstate_fail_job);
