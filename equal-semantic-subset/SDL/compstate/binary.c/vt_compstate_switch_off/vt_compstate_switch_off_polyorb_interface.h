...
#ifndef vt_compstate_switch_off_POLYORB_INTERFACE
#define vt_compstate_switch_off_POLYORB_INTERFACE
#include <stddef.h>
...
----------------------------------------------------*/
void po_hi_c_vt_compstate_switch_off_artificial_switch_off(__po_hi_task_id, dataview__mystring_buffer_impl);
...
------------------------------------------------------ */
void vm_vt_compstate_switch_off_check_queue_vt(void *, size_t *);
#endif
