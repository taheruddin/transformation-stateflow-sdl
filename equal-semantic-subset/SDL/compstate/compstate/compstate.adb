    ...
    procedure runTransition(Id: Integer) is
        ...
        begin
            while (trId /= -1) loop
                case trId is
                    when 0 =>
                        -- NEXT_STATE OFF (93,18) at 346, 66
                        trId := -1;
                        ctxt.state := OFF;
                    ...
                    when 4 =>
                        ...
                        -- NEXT_STATE ON (137,22) at 346, 231
                        trId := onÜSTART;
                        goto next_transition;
                    when 5 =>
                        -- entry (None,None)
                        pÜonÜentry;
                        -- NEXT_STATE onÜREADY (16,26) at 66, 453
                        trId := -1;
                        ctxt.state := onÜREADY;
                        goto next_transition;
                    when 6 =>
                    ...
                    when 7 =>
                        ...
                        -- exit (None,None)
                        pÜonÜexit;
                        -- RETURN troubleshoot (None,None) at 279, 494
                        trId := 3;
                        goto next_transition;
                    when 8 =>
                        -- out_msg('READY') (44,27)
                        ...
                        -- NEXT_STATE onÜREADY (46,30) at 437, 489
                        trId := -1;
                        ctxt.state := onÜREADY;
                        goto next_transition;
                    when 9 =>
                    ...
                    when 10 =>
                        ...
                        -- NEXT_STATE onÜRECORDING (64,30) at 422, 267
                        trId := -1;
                    ...
                    when 11 =>
                        ...
                        -- NEXT_STATE onÜPAUSED (73,30) at 266, 267
                        trId := -1;
