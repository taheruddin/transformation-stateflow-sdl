...
isSubcomponent('deploymentview::DV','Node1','others','IV_compstate','SYSTEM','interfaceview::IV::compstate.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','IV_compstate','Taste::FunctionName','"compstate"','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','IV_compstate','Taste::APLC_Binding','(reference (chip))','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','chip','Taste::coordinates','"88592 61326 129982 88121"','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','x86_linux','Taste::coordinates','"83418 53670 135156 91949"','').
...
isProperty('NIL','=>','deploymentview::DV','deploymentview','others','Node1','Taste::coordinates','"76951 42733 141623 97417"','').
