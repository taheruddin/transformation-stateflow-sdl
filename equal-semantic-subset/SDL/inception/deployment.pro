...
isSubcomponent('deploymentview::DV','Node1','others','IV_initsys','SYSTEM','interfaceview::IV::initsys.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','IV_initsys','Taste::FunctionName','"initsys"','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','IV_initsys','Taste::APLC_Binding','(reference (chip))','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','chip','Taste::coordinates','"90652 58215 130051 76988"','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','x86_linux','Taste::coordinates','"85727 52851 134976 79670"','').
...
isProperty('NIL','=>','deploymentview::DV','deploymentview','others','Node1','Taste::coordinates','"79571 45189 141132 83501"','').
