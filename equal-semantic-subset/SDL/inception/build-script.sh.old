...
# Generate code for OpenGEODE function initsys
cd "$SKELS"/initsys && opengeode --toAda initsys.pr system_structure.pr && cd $OLDPWD

cd "$SKELS" && rm -f initsys.zip && zip initsys initsys/* && cd $OLDPWD
...
cd "$CWD" && assert-builder-ocarina.py \
	...
	-o "$OUTPUTDIR" \
	--subAda initsys:"$SKELS"/initsys.zip \
