...
/*!
 * Store the period time for task initsys
 */
 ...
 */
  __po_hi_create_sporadic_task (chip_initsys_k, &(period), 1, 50000, 0, initsys_job);
  
/*!
 * Store the period time for task vt_gui_outmsg
 */
  __po_hi_milliseconds (&(period), 1);
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (chip_vt_gui_outmsg_k, &(period), 1, 50000, 0, vt_gui_outmsg_job);
