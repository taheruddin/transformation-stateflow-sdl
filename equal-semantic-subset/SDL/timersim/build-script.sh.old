...
# Generate code for OpenGEODE function timersys
cd "$SKELS"/timersys && opengeode --toAda timersys.pr system_structure.pr && cd $OLDPWD

cd "$SKELS" && rm -f timersys.zip && zip timersys timersys/* && cd $OLDPWD
...
cd "$CWD" && assert-builder-ocarina.py \
	...
	-o "$OUTPUTDIR" \
	--subAda timersys:"$SKELS"/timersys.zip \
