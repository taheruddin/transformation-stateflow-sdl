...
typedef dataview__stream_element_buffer dataview__t_boolean_buffer_max_impl[8];

typedef __po_hi_uint32_t base_types__unsigned_32;

typedef struct
{
  dataview__t_boolean_buffer_max_impl buffer;

  base_types__unsigned_32 length;

} dataview__t_boolean_buffer_impl;
