...
void vm_async_gui_inputmsg(void *into, size_t into_len)
{
   switch(__po_hi_get_task_id()) {
      case chip_vt_gui_outputmsg_k: vm_async_vt_gui_outputmsg_inputmsg_vt(into, into_len); break;
      case chip_vt_gui_gui_polling_gui_k: vm_async_vt_gui_gui_polling_gui_inputmsg_vt(into, into_len); break;
      default: break;
   }
}
