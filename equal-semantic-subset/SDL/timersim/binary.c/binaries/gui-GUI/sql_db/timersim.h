#ifndef GENERATED_ASN1SCC_TIMERSIM_H
#define GENERATED_ASN1SCC_TIMERSIM_H
/*
...
#define TASTE_Boolean_REQUIRED_BYTES_FOR_XER_ENCODING   44

void TASTE_Boolean_Initialize(TASTE_Boolean* pVal);
flag TASTE_Boolean_IsConstraintValid(const TASTE_Boolean* val, int* pErrCode);
flag TASTE_Boolean_Equal(const TASTE_Boolean* val1, const TASTE_Boolean* val2);
...
flag TASTE_Boolean_Encode(const TASTE_Boolean* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag TASTE_Boolean_Decode(TASTE_Boolean* pVal, BitStream* pBitStrm, int* pErrCode);
flag TASTE_Boolean_ACN_Encode(const TASTE_Boolean* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
