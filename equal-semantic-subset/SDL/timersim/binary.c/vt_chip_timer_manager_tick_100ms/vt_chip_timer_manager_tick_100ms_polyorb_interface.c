...
void vm_async_vt_chip_timer_manager_tick_100ms_timersys_sdltmr_vt()
{
   ...
   request.port = vt_chip_timer_manager_tick_100ms_global_outport_timersys_sdltmr_vt;
   __po_hi_gqueue_store_out(chip_vt_chip_timer_manager_tick_100ms_k, vt_chip_timer_manager_tick_100ms_local_outport_timersys_sdltmr_vt, &request);
   __po_hi_send_output(chip_vt_chip_timer_manager_tick_100ms_k, vt_chip_timer_manager_tick_100ms_global_outport_timersys_sdltmr_vt);
}
