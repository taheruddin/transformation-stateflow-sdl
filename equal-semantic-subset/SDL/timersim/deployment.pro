...
isSubcomponent('deploymentview::DV','Node1','others','IV_timerSys','SYSTEM','interfaceview::IV::timerSys.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','IV_timerSys','Taste::FunctionName','"timerSys"','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','IV_timerSys','Taste::APLC_Binding','(reference (chip))','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','chip','Taste::coordinates','"92457 59849 130703 78381"','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','x86_linux','Taste::coordinates','"87676 54554 135484 81028"','').
...
isProperty('NIL','=>','deploymentview::DV','deploymentview','others','Node1','Taste::coordinates','"81700 46990 141460 84810"','').
