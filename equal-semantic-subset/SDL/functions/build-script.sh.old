...
# Generate code for OpenGEODE function functions
cd "$SKELS"/functions && opengeode --toAda functions.pr system_structure.pr && cd $OLDPWD

cd "$SKELS" && rm -f functions.zip && zip functions functions/* && cd $OLDPWD
...
cd "$CWD" && assert-builder-ocarina.py \
	...
	-o "$OUTPUTDIR" \
	--subAda functions:"$SKELS"/functions.zip \
