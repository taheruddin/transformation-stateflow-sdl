...
isSubcomponent('deploymentview::DV','Node1','others','IV_functions','SYSTEM','interfaceview::IV::functions.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','IV_functions','Taste::FunctionName','"functions"','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','IV_functions','Taste::APLC_Binding','(reference (chip))','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','chip','Taste::coordinates','"88966 60585 129937 85135"','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','x86_linux','Taste::coordinates','"83845 53571 135058 88642"','').
...
isProperty('NIL','=>','deploymentview::DV','deploymentview','others','Node1','Taste::coordinates','"77443 43551 141460 93652"','').
