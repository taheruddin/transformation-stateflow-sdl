...
isSubcomponent('deploymentview::DV','Node1','others','IV_guard_4','SYSTEM','interfaceview::IV::guard_4.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','IV_guard_4','Taste::FunctionName','"guard_4"','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','IV_guard_4','Taste::APLC_Binding','(reference (chip))','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','chip','Taste::coordinates','"88236 58543 129520 81326"','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','x86_linux','Taste::coordinates','"83075 52033 134681 84581"','').
...
isProperty('NIL','=>','deploymentview::DV','deploymentview','others','Node1','Taste::coordinates','"76624 42733 141132 89231"','').
