...
void __po_hi_marshall_request_guard_4_inport_e 
    (__po_hi_request_t* request,
    __po_hi_msg_t* message,
    __po_hi_uint32_t* offset)
{

  __po_hi_marshall_type_myreal_buffer_impl (request->vars.guard_4_global_inport_e.guard_4_global_inport_e, message, offset);
}

void __po_hi_unmarshall_request_guard_4_inport_e 
    (__po_hi_request_t* request,
    __po_hi_msg_t* message,
    __po_hi_uint32_t* offset)
{

  __po_hi_unmarshall_type_myreal_buffer_impl (&(request->vars.guard_4_global_inport_e.guard_4_global_inport_e), message, offset);
}

void __po_hi_marshall_request_guard_4_outport_out_msg 
    (__po_hi_request_t* request,
    __po_hi_msg_t* message,
    __po_hi_uint32_t* offset)
{

  __po_hi_marshall_type_mystring_buffer_impl (request->vars.guard_4_global_outport_out_msg.guard_4_global_outport_out_msg, message, offset);
}

void __po_hi_unmarshall_request_guard_4_outport_out_msg 
    (__po_hi_request_t* request,
    __po_hi_msg_t* message,
    __po_hi_uint32_t* offset)
{

  __po_hi_unmarshall_type_mystring_buffer_impl (&(request->vars.guard_4_global_outport_out_msg.guard_4_global_outport_out_msg), message, offset);
}
    ...
    __po_hi_msg_t* message)
{
  ...
  switch (request->port)
  {
    ...
    {
      __po_hi_marshall_request_guard_4_inport_e (request, message, &(offset));

      break;
    }
    case guard_4_global_outport_out_msg:
    {
      __po_hi_marshall_request_guard_4_outport_out_msg (request, message, &(offset));
    ...
    __po_hi_msg_t* message)
{
  ...
  switch (request->port)
  {
    case guard_4_global_inport_e:
    {
      __po_hi_unmarshall_request_guard_4_inport_e (request, message, &(offset));

      break;
    }
    case guard_4_global_outport_out_msg:
    {
      __po_hi_unmarshall_request_guard_4_outport_out_msg (request, message, &(offset));
