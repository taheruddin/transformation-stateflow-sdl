...
# Generate code for OpenGEODE function guard_4
cd "$SKELS"/guard_4 && opengeode --toAda guard_4.pr system_structure.pr && cd $OLDPWD

cd "$SKELS" && rm -f guard_4.zip && zip guard_4 guard_4/* && cd $OLDPWD
...
cd "$CWD" && assert-builder-ocarina.py \
	...
	-o "$OUTPUTDIR" \
	--subAda guard_4:"$SKELS"/guard_4.zip \
