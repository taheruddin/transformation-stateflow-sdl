...
extern void init_gui (void);
extern void init_guard_1 (void);
extern void init_guard_1 (void);
process_package__taste_protected_object gui_protected;
process_package__taste_protected_object guard_1_protected;
 ...
 */
  ...
  guard_1_protected.protected_id = 1;
...
/*!
 * Store the period time for task vt_guard_1_get_data
 */
  __po_hi_milliseconds (&(period), 1);
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (chip_vt_guard_1_get_data_k, &(period), 1, 50000, 0, vt_guard_1_get_data_job);
  
/*!
 * Store the period time for task vt_guard_1_check
 */
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (chip_vt_guard_1_check_k, &(period), 9, 50000, 0, vt_guard_1_check_job);
