...
isSubcomponent('deploymentview::DV','Node1','others','IV_guard_1','SYSTEM','interfaceview::IV::guard_1.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','IV_guard_1','Taste::FunctionName','"guard_1"','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','IV_guard_1','Taste::APLC_Binding','(reference (chip))','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','chip','Taste::coordinates','"89847 59638 129875 82824"','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','x86_linux','Taste::coordinates','"84843 53014 134878 86136"','').
...
isProperty('NIL','=>','deploymentview::DV','deploymentview','others','Node1','Taste::coordinates','"78589 43551 141132 90868"','').
