...
isSubcomponent('deploymentview::DV','Node1','others','IV_guard_3','SYSTEM','interfaceview::IV::guard_3.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','IV_guard_3','Taste::FunctionName','"guard_3"','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','IV_guard_3','Taste::APLC_Binding','(reference (chip))','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','chip','Taste::coordinates','"94941 63912 133293 88301"','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','x86_linux','Taste::coordinates','"90147 56944 138087 91785"','').
...
isProperty('NIL','=>','deploymentview::DV','deploymentview','others','Node1','Taste::coordinates','"84155 46990 144079 96762"','').
