...
#ifndef guard_3_POLYORB_INTERFACE
#define guard_3_POLYORB_INTERFACE
#include <stddef.h>
...
----------------------------------------------------*/
void po_hi_c_guard_3_e(__po_hi_task_id, dataview__myreal_buffer_impl);
...
------------------------------------------------------ */
void vm_guard_3_check_queue(void *, size_t *);
#endif
