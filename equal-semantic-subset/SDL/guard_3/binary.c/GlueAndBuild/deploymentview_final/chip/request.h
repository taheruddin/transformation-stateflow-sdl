...
typedef struct
{
  ...
  union
  {
    struct
    {
      dataview__myreal_buffer_impl guard_3_global_inport_e;

    } guard_3_global_inport_e;

    struct
    {
      dataview__mystring_buffer_impl guard_3_global_outport_out_msg;

    } guard_3_global_outport_out_msg;
