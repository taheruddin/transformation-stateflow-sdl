...
void __po_hi_marshall_request_guard_3_inport_e 
    (__po_hi_request_t* request,
    __po_hi_msg_t* message,
    __po_hi_uint32_t* offset)
{

  __po_hi_marshall_type_myreal_buffer_impl (request->vars.guard_3_global_inport_e.guard_3_global_inport_e, message, offset);
}

void __po_hi_unmarshall_request_guard_3_inport_e 
    (__po_hi_request_t* request,
    __po_hi_msg_t* message,
    __po_hi_uint32_t* offset)
{

  __po_hi_unmarshall_type_myreal_buffer_impl (&(request->vars.guard_3_global_inport_e.guard_3_global_inport_e), message, offset);
}

void __po_hi_marshall_request_guard_3_outport_out_msg 
    (__po_hi_request_t* request,
    __po_hi_msg_t* message,
    __po_hi_uint32_t* offset)
{

  __po_hi_marshall_type_mystring_buffer_impl (request->vars.guard_3_global_outport_out_msg.guard_3_global_outport_out_msg, message, offset);
}

void __po_hi_unmarshall_request_guard_3_outport_out_msg 
    (__po_hi_request_t* request,
    __po_hi_msg_t* message,
    __po_hi_uint32_t* offset)
{

  __po_hi_unmarshall_type_mystring_buffer_impl (&(request->vars.guard_3_global_outport_out_msg.guard_3_global_outport_out_msg), message, offset);
}
    ...
    __po_hi_uint32_t* offset)
{
  ...
  __po_hi_marshall_type_myreal_buffer_impl (request->vars.vt_gui_out_msg_global_outport_e_vt.vt_gui_out_msg_global_outport_e_vt, message, offset);
}
    ...
    __po_hi_uint32_t* offset)
{
  ...
  __po_hi_unmarshall_type_myreal_buffer_impl (&(request->vars.vt_gui_out_msg_global_outport_e_vt.vt_gui_out_msg_global_outport_e_vt), message, offset);
}
    ...
    __po_hi_uint32_t* offset)
{
  ...
  __po_hi_marshall_type_myreal_buffer_impl (request->vars.vt_gui_gui_polling_gui_global_outport_e_vt.vt_gui_gui_polling_gui_global_outport_e_vt, message, offset);
}
    ...
    __po_hi_uint32_t* offset)
{
  ...
  __po_hi_unmarshall_type_myreal_buffer_impl (&(request->vars.vt_gui_gui_polling_gui_global_outport_e_vt.vt_gui_gui_polling_gui_global_outport_e_vt), message, offset);
}
    ...
    __po_hi_msg_t* message)
{
  ...
  switch (request->port)
  {
    ...
    {
      __po_hi_marshall_request_guard_3_inport_e (request, message, &(offset));

      break;
    }
    case guard_3_global_outport_out_msg:
    {
      __po_hi_marshall_request_guard_3_outport_out_msg (request, message, &(offset));
    ...
    __po_hi_msg_t* message)
{
  ...
  switch (request->port)
  {
    case guard_3_global_inport_e:
    {
      __po_hi_unmarshall_request_guard_3_inport_e (request, message, &(offset));

      break;
    }
    case guard_3_global_outport_out_msg:
    {
      __po_hi_unmarshall_request_guard_3_outport_out_msg (request, message, &(offset));
