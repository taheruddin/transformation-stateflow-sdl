...
void vm_async_vt_gui_gui_polling_gui_e_vt(void *imsg, size_t imsg_len)
{
   ...
   __po_hi_copy_array(&(request.vars.vt_gui_gui_polling_gui_global_outport_e_vt.vt_gui_gui_polling_gui_global_outport_e_vt.buffer), imsg, imsg_len);
   request.vars.vt_gui_gui_polling_gui_global_outport_e_vt.vt_gui_gui_polling_gui_global_outport_e_vt.length = imsg_len;
