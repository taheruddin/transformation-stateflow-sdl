...
void gui_RI_e(const asn1SccMyString *);

#define INVOKE_RI_e(params) gui_RI_e(&((T_e__data*)params)->imsg);

void gui_PI_gui_polling_gui();

void gui_PI_out_msg(const asn1SccMyString* omsg);
