...
def setUDP():
    global udp
    global tcId
    from _InterfaceEnum import i_gui_RI_e
    tcId = i_gui_RI_e
    udp = True
...
def setSharedLib(dll=None):
    ...
    global shared_lib
    global e_via_shared_lib
    shared_lib = True
    e_via_shared_lib = dll.gui_e
