...
# Generate code for OpenGEODE function guard_2
cd "$SKELS"/guard_2 && opengeode --toAda guard_2.pr system_structure.pr && cd $OLDPWD

cd "$SKELS" && rm -f guard_2.zip && zip guard_2 guard_2/* && cd $OLDPWD
...
cd "$CWD" && assert-builder-ocarina.py \
	...
	-o "$OUTPUTDIR" \
	--subAda guard_2:"$SKELS"/guard_2.zip \
