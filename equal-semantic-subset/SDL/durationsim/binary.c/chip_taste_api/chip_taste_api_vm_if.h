...
void chip_taste_api_durationsys_has_pending_msg (void *pmy_res, size_t *psize_my_res);
extern void chip_taste_api_PI_durationsys_has_pending_msg (asn1SccT_Boolean *);
