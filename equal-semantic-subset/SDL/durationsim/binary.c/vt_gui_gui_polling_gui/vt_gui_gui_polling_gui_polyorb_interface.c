...
------------------------------------------------------ */
void vm_async_vt_gui_gui_polling_gui_inputmsg_vt(void *inmsg, size_t inmsg_len)
{
   __po_hi_request_t request;

   __po_hi_copy_array(&(request.vars.vt_gui_gui_polling_gui_global_outport_inputmsg_vt.vt_gui_gui_polling_gui_global_outport_inputmsg_vt.buffer), inmsg, inmsg_len);
   request.vars.vt_gui_gui_polling_gui_global_outport_inputmsg_vt.vt_gui_gui_polling_gui_global_outport_inputmsg_vt.length = inmsg_len;
