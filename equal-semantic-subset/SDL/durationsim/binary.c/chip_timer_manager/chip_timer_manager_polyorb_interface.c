...
{
   vm_async_vt_chip_timer_manager_tick_100ms_durationsys_sdltmr_vt();
}
...
void sync_chip_timer_manager_durationsys_RESET_sdltmr()
{
   extern process_package__taste_protected_object chip_timer_manager_protected;
   __po_hi_protected_lock (chip_timer_manager_protected.protected_id);
   chip_timer_manager_durationsys_RESET_sdltmr();
   __po_hi_protected_unlock (chip_timer_manager_protected.protected_id);
}
...
----------------------------------------------------*/
void sync_chip_timer_manager_durationsys_SET_sdltmr(void *duration, size_t duration_len)
{
   extern process_package__taste_protected_object chip_timer_manager_protected;
   __po_hi_protected_lock (chip_timer_manager_protected.protected_id);
   chip_timer_manager_durationsys_SET_sdltmr(duration, duration_len);
   __po_hi_protected_unlock (chip_timer_manager_protected.protected_id);
}
