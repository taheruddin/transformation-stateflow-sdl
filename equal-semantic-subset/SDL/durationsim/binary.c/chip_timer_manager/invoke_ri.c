...
void chip_timer_manager_RI_durationsys_sdltmr()
{
#ifdef __unix__
    ...
    if (1 == innerMsc) {
        ...
        printf ("\nINNER: chip_timer_manager,durationsys,durationsys_sdltmr,%lld\n", msc_time);
        fflush(stdout);
    }
#endif
    ...
    extern void vm_async_chip_timer_manager_durationsys_sdltmr();

    vm_async_chip_timer_manager_durationsys_sdltmr();
