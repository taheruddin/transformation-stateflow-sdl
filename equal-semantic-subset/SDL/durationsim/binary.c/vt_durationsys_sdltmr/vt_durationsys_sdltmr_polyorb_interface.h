...
#ifndef vt_durationsys_sdltmr_POLYORB_INTERFACE
#define vt_durationsys_sdltmr_POLYORB_INTERFACE
#include <stddef.h>
...
----------------------------------------------------*/
void po_hi_c_vt_durationsys_sdltmr_artificial_sdltmr(__po_hi_task_id);
...
------------------------------------------------------ */
void vm_vt_durationsys_sdltmr_check_queue_vt(void *, size_t *);
#endif
