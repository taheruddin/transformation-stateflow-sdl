...
void __po_hi_marshall_request_vt_durationsys_sdltmr_inport_artificial_sdltmr 
    (__po_hi_request_t* request,
    __po_hi_msg_t* message,
    __po_hi_uint32_t* offset);

void __po_hi_unmarshall_request_vt_durationsys_sdltmr_inport_artificial_sdltmr 
    (__po_hi_request_t* request,
    __po_hi_msg_t* message,
    __po_hi_uint32_t* offset);
...
void __po_hi_marshall_request_vt_chip_timer_manager_tick_100ms_outport_durationsys_sdltmr_vt 
    (__po_hi_request_t* request,
    __po_hi_msg_t* message,
    __po_hi_uint32_t* offset);

void __po_hi_unmarshall_request_vt_chip_timer_manager_tick_100ms_outport_durationsys_sdltmr_vt 
    (__po_hi_request_t* request,
    __po_hi_msg_t* message,
    __po_hi_uint32_t* offset);
