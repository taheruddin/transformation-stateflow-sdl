...
isSubcomponent('deploymentview::DV','Node1','others','IV_gui','SYSTEM','interfaceview::IV::gui.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','IV_gui','Taste::FunctionName','"gui"','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','IV_gui','Taste::APLC_Binding','(reference (chip))','').
isSubcomponent('deploymentview::DV','Node1','others','IV_durationSys','SYSTEM','interfaceview::IV::durationSys.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','IV_durationSys','Taste::FunctionName','"durationSys"','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','IV_durationSys','Taste::APLC_Binding','(reference (chip))','').
isComponentType('deploymentview::DV::Node1','PUBLIC','chip','PROCESS','NIL','').
isComponentImplementation('deploymentview::DV::Node1','PUBLIC','chip','others','PROCESS','NIL','others','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','chip','Actual_Processor_Binding','(reference (x86_linux))','').
isSubcomponent('deploymentview::DV','Node1','others','chip','PROCESS','deploymentview::DV::Node1::chip.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','chip','Taste::coordinates','"95902 61590 131842 79801"','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','chip','Deployment::Port_Number','0','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','x86_linux','Taste::coordinates','"91409 56387 136335 82403"','').
...
isProperty('NIL','=>','deploymentview::DV','deploymentview','others','Node1','Taste::coordinates','"85793 48954 141951 86120"','').
