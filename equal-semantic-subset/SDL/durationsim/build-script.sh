...
# Generate code for OpenGEODE function durationsys
cd "$SKELS"/durationsys && opengeode --toAda durationsys.pr system_structure.pr && cd $OLDPWD

cd "$SKELS" && rm -f durationsys.zip && zip durationsys durationsys/* && cd $OLDPWD
...
cd "$CWD" && assert-builder-ocarina.py \
	...
	-o "$OUTPUTDIR" \
	--subAda durationsys:"$SKELS"/durationsys.zip \
