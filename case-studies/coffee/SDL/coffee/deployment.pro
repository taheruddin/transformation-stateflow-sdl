...
isSubcomponent('deploymentview::DV','Node1','others','IV_coffee','SYSTEM','interfaceview::IV::coffee.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','IV_coffee','Taste::FunctionName','"coffee"','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','IV_coffee','Taste::APLC_Binding','(reference (chip))','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','chip','Taste::coordinates','"87968 59557 129462 84748"','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','x86_linux','Taste::coordinates','"82781 52360 134649 88347"','').
...
isProperty('NIL','=>','deploymentview::DV','deploymentview','others','Node1','Taste::coordinates','"76297 42078 141132 93488"','').
