...
#include "vt_coffee_for_water_polyorb_interface.h"
...
------------------------------------------------------ */
void po_hi_c_vt_coffee_for_water_artificial_for_water(__po_hi_task_id e, dataview__mystring_buffer_impl buf)
{
    (void)e;
   sync_coffee_for_water (buf.buffer, buf.length);
}
...
void vm_async_vt_coffee_for_water_out_msg_vt(void *msg, size_t msg_len)
{
   ...
   __po_hi_copy_array(&(request.vars.vt_coffee_for_water_global_outport_out_msg_vt.vt_coffee_for_water_global_outport_out_msg_vt.buffer), msg, msg_len);
   request.vars.vt_coffee_for_water_global_outport_out_msg_vt.vt_coffee_for_water_global_outport_out_msg_vt.length = msg_len;
   request.port = vt_coffee_for_water_global_outport_out_msg_vt;
   __po_hi_gqueue_store_out(chip_vt_coffee_for_water_k, vt_coffee_for_water_local_outport_out_msg_vt, &request);
...
------------------------------------------------------ */
void vm_vt_coffee_for_water_check_queue_vt(void *res, size_t *res_len)
{
