...
#ifndef vt_coffee_tmr_POLYORB_INTERFACE
#define vt_coffee_tmr_POLYORB_INTERFACE
#include <stddef.h>
...
----------------------------------------------------*/
void po_hi_c_vt_coffee_tmr_artificial_tmr(__po_hi_task_id);
...
------------------------------------------------------ */
void vm_vt_coffee_tmr_check_queue_vt(void *, size_t *);
#endif
