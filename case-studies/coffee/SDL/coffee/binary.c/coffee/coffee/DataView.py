...
exportedTypes["TASTE-Dataview"] = ["MyInteger", "MyString", "T-Int32", "T-UInt32", "T-Int8", "T-UInt8", "T-Boolean"]
...
types["MyInteger"] = type("MyInteger", (object,), {
    "Line": 22, "CharPositionInLine": 0, "type": type("MyInteger_type", (object,), {
        "Line": 22, "CharPositionInLine": 16, "kind": "IntegerType", "Min": "0", "Max": "255"
    })
})
