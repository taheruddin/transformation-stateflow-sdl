...
#include "vt_coffee_get_init_tmpr_polyorb_interface.h"
...
------------------------------------------------------ */
void po_hi_c_vt_coffee_get_init_tmpr_artificial_get_init_tmpr(__po_hi_task_id e, dataview__t_int32_buffer_impl buf)
{
    (void)e;
   sync_coffee_get_init_tmpr (buf.buffer, buf.length);
}
...
{
   sync_coffee_get_init_tmpr(init_tmpr, init_tmpr_len);
}
...
void vm_async_vt_coffee_get_init_tmpr_out_msg_vt(void *msg, size_t msg_len)
{
   ...
   __po_hi_copy_array(&(request.vars.vt_coffee_get_init_tmpr_global_outport_out_msg_vt.vt_coffee_get_init_tmpr_global_outport_out_msg_vt.buffer), msg, msg_len);
   request.vars.vt_coffee_get_init_tmpr_global_outport_out_msg_vt.vt_coffee_get_init_tmpr_global_outport_out_msg_vt.length = msg_len;
   request.port = vt_coffee_get_init_tmpr_global_outport_out_msg_vt;
   __po_hi_gqueue_store_out(chip_vt_coffee_get_init_tmpr_k, vt_coffee_get_init_tmpr_local_outport_out_msg_vt, &request);
...
------------------------------------------------------ */
void vm_vt_coffee_get_init_tmpr_check_queue_vt(void *res, size_t *res_len)
{
