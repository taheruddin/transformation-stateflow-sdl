...
# Generate code for OpenGEODE function coffee
cd "$SKELS"/coffee && opengeode --toAda coffee.pr system_structure.pr && cd $OLDPWD

cd "$SKELS" && rm -f coffee.zip && zip coffee coffee/* && cd $OLDPWD
...
cd "$CWD" && assert-builder-ocarina.py \
	...
	-o "$OUTPUTDIR" \
	--subAda coffee:"$SKELS"/coffee.zip \
