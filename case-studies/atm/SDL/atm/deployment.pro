...
isSubcomponent('deploymentview::DV','Node1','others','IV_atm','SYSTEM','interfaceview::IV::atm.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','IV_atm','Taste::FunctionName','"atm"','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','IV_atm','Taste::APLC_Binding','(reference (chip))','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','chip','Taste::coordinates','"88295 62324 129789 90323"','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','x86_linux','Taste::coordinates','"83108 54324 134976 94323"','').
...
isProperty('NIL','=>','deploymentview::DV','deploymentview','others','Node1','Taste::coordinates','"76624 42896 141460 100037"','').
