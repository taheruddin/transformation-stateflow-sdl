...
# Generate code for OpenGEODE function atm
cd "$SKELS"/atm && opengeode --toAda atm.pr system_structure.pr && cd $OLDPWD

cd "$SKELS" && rm -f atm.zip && zip atm atm/* && cd $OLDPWD
