...
#ifndef ERR_MyString 
#define ERR_MyString		1006  /*(SIZE(0 .. 255))*/
#endif

typedef asn1SccUint Num;

#define Num_REQUIRED_BYTES_FOR_ENCODING       1 
#define Num_REQUIRED_BITS_FOR_ENCODING        4
#define Num_REQUIRED_BYTES_FOR_ACN_ENCODING   1 
#define Num_REQUIRED_BITS_FOR_ACN_ENCODING    4
#define Num_REQUIRED_BYTES_FOR_XER_ENCODING   31

void Num_Initialize(Num* pVal);
flag Num_IsConstraintValid(const Num* val, int* pErrCode);
flag Num_Equal(const Num* val1, const Num* val2);

#ifndef ERR_Num 
#define ERR_Num		1007  /*(0 .. 9)*/
#endif

typedef asn1SccUint Amount;

#define Amount_REQUIRED_BYTES_FOR_ENCODING       3 
#define Amount_REQUIRED_BITS_FOR_ENCODING        20
#define Amount_REQUIRED_BYTES_FOR_ACN_ENCODING   3 
#define Amount_REQUIRED_BITS_FOR_ACN_ENCODING    20
#define Amount_REQUIRED_BYTES_FOR_XER_ENCODING   37

void Amount_Initialize(Amount* pVal);
flag Amount_IsConstraintValid(const Amount* val, int* pErrCode);
flag Amount_Equal(const Amount* val1, const Amount* val2);

#ifndef ERR_Amount 
#define ERR_Amount		1008  /*(0 .. 999999)*/
#endif
...
flag Num_Encode(const Num* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag Num_Decode(Num* pVal, BitStream* pBitStrm, int* pErrCode);
flag Num_ACN_Encode(const Num* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag Num_ACN_Decode(Num* pVal, BitStream* pBitStrm, int* pErrCode);
flag Amount_Encode(const Amount* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag Amount_Decode(Amount* pVal, BitStream* pBitStrm, int* pErrCode);
flag Amount_ACN_Encode(const Amount* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag Amount_ACN_Decode(Amount* pVal, BitStream* pBitStrm, int* pErrCode); 
