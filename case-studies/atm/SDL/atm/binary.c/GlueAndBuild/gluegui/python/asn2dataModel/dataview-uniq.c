...
flag Num_IsConstraintValid(const Num* pVal, int* pErrCode)
{
	...
	*pErrCode=0;
	...
	ret = (*pVal <= 9);
	*pErrCode = ret ? 0 : ERR_Num;

	return ret;
}

flag Num_Equal(const Num* pVal1, const Num* pVal2)
{
	flag ret=TRUE;
...
flag Num_Encode(const Num* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
    
	ret = bCheckConstraints ? Num_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret) {
...
flag Num_ACN_Encode(const Num* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
...
flag Amount_IsConstraintValid(const Amount* pVal, int* pErrCode)
{
	...
	*pErrCode=0;
	...
	ret = (*pVal <= 999999);
	*pErrCode = ret ? 0 : ERR_Amount;

	return ret;
}

flag Amount_Equal(const Amount* pVal1, const Amount* pVal2)
{
	flag ret=TRUE;
...
flag Amount_Encode(const Amount* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
    
	ret = bCheckConstraints ? Amount_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret) {
...
flag Amount_ACN_Encode(const Amount* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
