...
def setUDP():
    global udp
    global tcId
    from _InterfaceEnum import i_gui_RI_ok
    tcId = i_gui_RI_ok
    udp = True
...
def setSharedLib(dll=None):
    ...
    global shared_lib
    global ok_via_shared_lib
    shared_lib = True
    ok_via_shared_lib = dll.gui_ok
