...
exportedTypes["TASTE-Dataview"] = ["MyReal", "MyString", "Num", "Amount", "T-Int32", "T-UInt32", "T-Int8", "T-UInt8", "T-Boolean"]
...
types["MyReal"] = type("MyReal", (object,), {
    "Line": 22, "CharPositionInLine": 0, "type": type("MyReal_type", (object,), {
        "Line": 22, "CharPositionInLine": 16, "kind": "RealType", "Min": "0.00000000000000000000E+000", "Max": "1.00000000000000000000E+003"
    })
})

types["MyString"] = type("MyString", (object,), {
    "Line": 23, "CharPositionInLine": 0, "type": type("MyString_type", (object,), {
        "Line": 23, "CharPositionInLine": 13, "kind": "OctetStringType", "Min": "0", "Max": "255"
    })
})

types["Num"] = type("Num", (object,), {
    "Line": 24, "CharPositionInLine": 0, "type": type("Num_type", (object,), {
        "Line": 24, "CharPositionInLine": 8, "kind": "IntegerType", "Min": "0", "Max": "9"
    })
})

types["Amount"] = type("Amount", (object,), {
    "Line": 25, "CharPositionInLine": 0, "type": type("Amount_type", (object,), {
        "Line": 25, "CharPositionInLine": 11, "kind": "IntegerType", "Min": "0", "Max": "999999"
    })
})
